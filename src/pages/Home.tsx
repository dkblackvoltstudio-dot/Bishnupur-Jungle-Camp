...
export default function Home() {
  ...
  return (
    <>
      <header className="relative pt-36 pb-32 px-6 flex items-center justify-center min-h-[90vh] lg:min-h-screen overflow-hidden">
        <motion.div 
          className="absolute inset-0 z-0 bg-cover bg-center"
          style={{ 
            backgroundImage: 'url("https://images.unsplash.com/photo-1511497584788-876760111969?auto=format&fit=crop&q=80&w=2670")',
            y: backgroundY
          }}
        />
        <div className="absolute inset-0 z-0 bg-gradient-to-b from-stone-900/40 via-stone-900/20 to-stone-900/90" />
